...
const BasicCard = ({t}) => (
    <Panel md={12} lg={6} xl={3} xs={12}>
        <div className="dashboard__product">
            ...
            <h5 className="subhead dashboard__product-subhead">Knowledge nay estimable questions repulsive daughters boy.
            </h5>
            <p className="typography-message">View in the item list</p>
        </div>
    </Panel>
);
