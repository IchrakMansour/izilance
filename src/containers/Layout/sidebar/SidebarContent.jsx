        ...
        return (
            <div className="sidebar__content">
                <ul className="sidebar__block">
                    ...
                    <SidebarLink title="Portefeuille" icon="briefcase" route="/portefeuille" onClick={this.hideSidebar}/>
                </ul>
                <ul className="sidebar__block__bottom">
                    ...
                    <SidebarLink title="Déconnexion" icon="exit" route="/logout" onClick={this.hideSidebar}/>
                </ul>
            </div>
        );
    }
